...
```{r histogram_with_NAs, echo=FALSE, cache=TRUE, fig.path="./figure/"}
...
```{r histogram_without_NAs, echo=FALSE, cache=TRUE,fig.path="./figure/"}
...
```{r weekdays_activity, echo=FALSE, cache=TRUE, fig.path="./figure/"}
